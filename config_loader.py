...
ENV_MAPPING = {
    ...
    ("cfg/login.toml", "api_key"): "IRIS_API_KEY",
...
CONFIG_DEFAULTS = {
    ...
    ("cfg/bot_config.toml", "super_pixels_minimum"): 100,
    ("cfg/bot_config.toml", "gadget_pixels_minimum"): 100,
    ("cfg/bot_config.toml", "hypercharge_pixels_minimum"): 100,
    ("cfg/bot_config.toml", "idle_pixels_minimum"): 500,
    ...
    # time_tresholds.toml
    ("cfg/time_tresholds.toml", "state_check_seconds"): 2,
    ("cfg/time_tresholds.toml", "no_detections_timeout"): 30,
    ("cfg/time_tresholds.toml", "idle_check_seconds"): 5,
    ("cfg/time_tresholds.toml", "super"): 5,
    ("cfg/time_tresholds.toml", "hypercharge"): 5,
    ("cfg/time_tresholds.toml", "gadget"): 5,
    ("cfg/time_tresholds.toml", "wall_detection"): 2,
    ("cfg/time_tresholds.toml", "no_detection_proceed"): 60,
    ("cfg/time_tresholds.toml", "check_if_brawl_stars_crashed"): 20,
    ("cfg/time_tresholds.toml", "idle"): 5,
    ("cfg/time_tresholds.toml", "state_check"): 2,
